...
void protobuf_AssignDesc_game_2eproto() {
  ...
  Player_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(Player));
  Room_descriptor_ = file->message_type(1);
  static const int Room_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Room, description_),
  };
  Room_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Room_descriptor_,
  ...
  static const int Item_offsets_[2] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Item, iskey_),
  };
  Item_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Item_descriptor_,
...
#ifndef _MSC_VER
const int Room::kDescriptionFieldNumber;
#endif  // !_MSC_VER

Room::Room()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:game.Room)
}
...
Room::Room(const Room& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:game.Room)
}
...
Room::~Room() {
  // @@protoc_insertion_point(destructor:game.Room)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:game.Room)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:game.Room)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:game.Room)
  return false;
#undef DO_
}
...
void Room::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:game.Room)
  // required string description = 1;
  if (has_description()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->description().data(), this->description().length(),
  ...
  // @@protoc_insertion_point(serialize_end:game.Room)
}

::google::protobuf::uint8* Room::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:game.Room)
  // required string description = 1;
  if (has_description()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->description().data(), this->description().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:game.Room)
  return target;
}
...
const int Item::kIsKeyFieldNumber;
#endif  // !_MSC_VER

Item::Item()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:game.Item)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:game.Item)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_isKey;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:game.Item)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:game.Item)
  return false;
#undef DO_
}
...
void Item::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:game.Item)
  // required string description = 1;
  if (has_description()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->description().data(), this->description().length(),
  ...
  // required bool isKey = 2;
  if (has_iskey()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(2, this->iskey(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:game.Item)
}
...
::google::protobuf::uint8* Item::SerializeWithCachedSizesToArray(
  ...
  // required bool isKey = 2;
  if (has_iskey()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(2, this->iskey(), target);
  }
